...
import Video from "../assets/images/doctor-new.jpeg";
      ...
      <div className="flex items-center justify-between flex-col lg:flex-row">
        ...
        <div className="xl:w-[670px]">
          ...
          <ul className="pl-4">
            ...
            <li className="text__para">
              3. Lorem ipsum dolor sit amet consectetur adipisicing elit. Ullam quam doloribus blanditiis laudantium dolores odit quasi neque maxime labore recusandae nemo eligendi architecto incidunt officiis distinctio aliquid, quos eaque inventore.
            </li>
          </ul>
          <Link to="/">
        ...
        <div className="w-[150px] lg:w-[248px] bg-white absolute bottom-[50px] left-0 md:buttom-[100px] md:left-5 z-20 p-2 pb-3 lg:pt-4 lg:px-4 lg:pb-[26px] rounded-[10px]">
